...
def TableDrivenVacuumAgent():
    ...
    table = {((loc_A, 'Clean'),): 'Right',
             ...
             ((loc_A, 'Dirty'), (loc_A, 'Clean')): 'Left',

             ((loc_A, 'Clean'), (loc_B, 'Dirty')): 'Left',

             ((loc_A, 'Dirty'), (loc_B, 'Dirty')): 'Suck',
...
def ModelBasedVacuumAgent():
    ...
    model = {loc_A: None, loc_B: None} #dictionary 
...
class TrivialVacuumEnvironment(Environment):
    ...
    def execute_action(self, agent, action):
        ...
        print("location : "+ str(agent.location)+" , status: "+str(self.status))
        if action == 'Right':
        ...
        print( " === > action: "+str(action) +" , performance="+ str(agent.performance))
